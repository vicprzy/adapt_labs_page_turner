...
const int ENA_PIN = 9;  // Speed control
const int IN1_PIN = 5;  // Direction control
...
void loop() {
  ...
  if (buttonPress) {
    ...
    digitalWrite(IN1_PIN, HIGH);  // lets the wheel start spinning
    ...
    digitalWrite(IN1_PIN, HIGH);  // wheel moved enough of page for servo to get under
